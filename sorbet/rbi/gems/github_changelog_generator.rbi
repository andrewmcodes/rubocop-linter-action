...
class GitHubChangelogGenerator::Parser
  ...
  def self.parse_options; end
  def self.setup_parser(options); end
end
...
class GitHubChangelogGenerator::OctoFetcher
  ...
  def commits; end
  def configure_octokit_ssl; end
  def default_branch; end
  def extract_request_args(args); end
...
class GitHubChangelogGenerator::Generator
  ...
  def filter_wo_labels(issues); end
