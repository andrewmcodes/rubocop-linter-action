...
module Octokit::Authentication
  ...
  def application_authentication; end
...
class Octokit::RateLimit < Anonymous_Struct_8
...
module Octokit::Client::Authorizations
  ...
  def check_application_authorization(token, options = nil); end
  def create_authorization(options = nil); end
  def delete_application_authorization(token, options = nil); end
  def delete_authorization(number, options = nil); end
  def reset_application_authorization(token, options = nil); end
  def revoke_all_application_authorizations(options = nil); end
  def revoke_application_authorization(token, options = nil); end
